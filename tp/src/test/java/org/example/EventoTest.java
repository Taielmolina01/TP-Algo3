...
public class EventoTest {
    ...
    public void testFrecuenciaSemanal() {
        ...
        // 15 de marzo 2020 cayó un domingo y 30 de diciembre 2021 cayó un jueves
        ...
        assertFalse(evento.hayEvento(LocalDateTime.of(2020, 3, 18, 0,0,0)));
        assertTrue(evento.hayEvento(LocalDateTime.of(2020, 3, 19, 0,0,0)));
        assertTrue(evento.hayEvento(LocalDateTime.of(2020, 3, 20, 0,0,0)));
        assertFalse(evento.hayEvento(LocalDateTime.of(2020, 3, 21, 0,0,0)));
        assertFalse(evento.hayEvento(LocalDateTime.of(2020, 3, 22, 0,0,0)));
        assertTrue(evento.hayEvento(LocalDateTime.of(2020, 3, 23, 0,0,0)));
        assertTrue(evento.hayEvento(LocalDateTime.of(2020, 3, 24, 0,0,0)));
        assertFalse(evento.hayEvento(LocalDateTime.of(2020, 3, 25, 0,0,0)));
        assertTrue(evento.hayEvento(LocalDateTime.of(2020, 3, 26, 0,0,0)));
        assertTrue(evento.hayEvento(LocalDateTime.of(2020, 3, 27, 0,0,0)));
        assertFalse(evento.hayEvento(LocalDateTime.of(2020, 3, 28, 0,0,0)));
        assertFalse(evento.hayEvento(LocalDateTime.of(2020, 3, 29, 0,0,0)));
